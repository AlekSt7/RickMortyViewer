...
import ru.alek.rickmortyviewer.presentation.character_card.adapters.CharacterAdapter
...
class CharacterCardFragment : DialogFragment() {
    ...
    private lateinit var viewModelFactory: CharacterCardViewModelFactory
    private lateinit var binding: CharacterCardFragmentBinding

    private val adapter = CharacterAdapter()

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        binding = CharacterCardFragmentBinding.inflate(layoutInflater)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModelFactory = DiContainer.injectCharacterCardViewModel()
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this, viewModelFactory)[CharacterCardFragmentViewModel::class.java]
